...
scoreboard players set @s eden.advancement.redstone.mined.nether_quartz_ore 0
scoreboard players set @s eden.advancement.redstone.crafted.redstone_torch 0