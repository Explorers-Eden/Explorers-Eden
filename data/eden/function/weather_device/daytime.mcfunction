...
title @a actionbar [{"bold":false,"color":"#70FF83","italic":false,"selector":"@s"},{"bold":false,"color":"#70FF83","italic":false,"text":" made it daytime"}]
...
clear @s minecraft:rabbit_foot[minecraft:custom_data={items:daytime_token}] 1