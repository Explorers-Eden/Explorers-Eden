...
title @a actionbar [{"bold":false,"color":"#70FF83","italic":false,"selector":"@s"},{"bold":false,"color":"#70FF83","italic":false,"text":" cleared out the rain clouds"}]
...
clear @s minecraft:rabbit_foot[minecraft:custom_data={items:clear_weather_token}] 1