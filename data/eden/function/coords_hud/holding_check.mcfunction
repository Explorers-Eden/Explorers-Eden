...
execute if items entity @s weapon.* minecraft:compass run function eden:coords_hud/update_coords with storage eden:coords_hud
execute unless items entity @s weapon.* minecraft:compass run function eden:coords_hud/hide_hud with storage eden:coords_hud