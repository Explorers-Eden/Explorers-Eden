...
give @s written_book\
[custom_data={book:oakhearted},written_book_content={\
title:"Oakhearted",author:"Explorer's Eden",generation:3,\
pages:['[{"text":"Oakhearted\\n\\n","color":"dark_green","bold":true},\
{"text":"In the heart of lush Forests, there exists a race known as the Dakhearted. These beings are deeply conected to the ancient trees that dominate their realm, embodying the strength, resilience, and wisdom of the Forest itself.","color":"black","bold":false}]',\
...
'[{"text":"Do you want to join the heritage of the Oakhearted?\\n\\n\\n"},\
{"text":"[Click to join]","bold":true,"clickEvent":{"action":"run_command","value":"/function eden:player_races/select/oakhearted"}}]']}] 1
