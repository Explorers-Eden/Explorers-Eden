...
give @s written_book[custom_data={book:orebringer},written_book_content={title:"Orebringer",author:"Explorer's Eden",generation:3,pages:['[{"text":"Orebringer\\n\\n","color":"gray","bold":true,"italic":false},{"text":"As guardians of subterranean realms, the Orebringers stand as a testament to the enduring power of the earth. Theirs is a legacy of craftsmanship and stewardship, their bond with the land unbreakable as the bedrock.","color":"black","bold":false}]','{"text":"Pros:\\n+ Is a hero of all villages\\n+ breaks blocks way faster\\n+ deals more damage","italic":false}','{"text":"Cons:\\n- slower movement\\n- slightly slower attack speed\\n- a bit less jump strength\\n- takes more damage from raider mobs"}','[{"text":"Click the villager in this room with the book in your mainhand if you want to join the heritage of the Orebringer.\\n\\n\\n"}]']}] 1
