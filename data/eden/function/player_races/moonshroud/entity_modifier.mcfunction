...
effect give @s[predicate=eden:world/night_time,predicate=eden:world/in_outer_wilds] minecraft:night_vision 20 0 true
...
attribute @s minecraft:generic.attack_damage modifier add atck_dmg_moonshroud -0.4 add_multiplied_base
