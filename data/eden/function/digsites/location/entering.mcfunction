...
title @s[advancement={eden:technical/class_chosen=true}]  subtitle [{"bold":false,"color":"#AD8F66","italic":false,"text":" ⛏ "},{"bold":false,"color":"#70FF83","italic":false,"text":"Entered Dig Site"}]
