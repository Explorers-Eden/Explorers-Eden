...
execute as @e[type=marker,tag=eden.digsite.sand,tag=!digsite_finished] at @s if score @s eden.digsite.placed matches ..41 if score @s eden.digsite.attempts matches ..999 run function eden:digsites/end/get_data
execute as @e[type=marker,tag=eden.digsite.snow,tag=!digsite_finished] at @s if score @s eden.digsite.placed matches ..41 if score @s eden.digsite.attempts matches ..999 run function eden:digsites/sand/get_data
